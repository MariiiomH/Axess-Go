...
class IntlPhoneField extends StatefulWidget {
 ...
 // final TextEditingController controller = new TextEditingController();
  ...
  IntlPhoneField({
    ...
    this.style,
    this.dropdownTextStyle = const TextStyle (color: const Color(0xFF555a6b) , fontSize: 18),
    //this.onSubmitted,
    this.validator,
    this.onChanged,
    this.countries,
    ...
    this.dropDownIcon = const Icon(Icons.arrow_drop_down , color: const Color(0xFF555a6b) , size: 35),
    ...
    this.flagsButtonPadding = const EdgeInsets.symmetric(vertical: 8 , horizontal: 9),
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry =
          _countryList.firstWhere((item) => item.code == (widget.initialCountryCode ?? 'EG'), orElse: () => _countryList.first);
    }
  ...
  Future<void> _changeCountry() async {
    ...
    await showDialog(
      ...
      barrierColor:const Color(0xFF2f323d),
      useRootNavigator: false,
      builder: (context) => StatefulBuilder(
        builder: (ctx, setState) => Dialog(
          backgroundColor : const Color(0xFF2f323d),
          child: Container(
              ...
              children: <Widget>[
                ...
                TextField(
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: const Color(0xFF555a6b)),
                  ),
                  onChanged: (value) {
                        ...
                        ListTile(
                          ...
                          */
                          trailing: Text(
                            ...
                            style: TextStyle(fontWeight: FontWeight.w700 , color: const Color(0xFF555a6b) ),
                          ),
